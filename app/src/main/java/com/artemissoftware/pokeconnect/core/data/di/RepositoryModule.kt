...
object RepositoryModule {
    ...
    @Provides
    @Singleton
    fun providePokemonRepository(pokeApiSource: PokeApiSource, pokemonDao: PokemonDao): PokemonRepository {
        return PokemonRepositoryImpl(pokeApiSource = pokeApiSource, pokemonDao = pokemonDao)
    }
}